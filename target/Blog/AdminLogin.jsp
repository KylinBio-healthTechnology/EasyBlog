...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
     <div class="container">
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="index.html">SSM Blog System</a>
       </div>
   ...
   <div class="container">
    <div class="row">
		<div class="col-md-6">
			<form name="login_form" class="form-horizontal" action='admin/Index.jsp?action=login' method="POST" onsubmit="return isValidate(login_form)">
			  <fieldset>
			    <div id="legend">
