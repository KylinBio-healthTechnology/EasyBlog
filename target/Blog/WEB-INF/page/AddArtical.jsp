					...
					<ul class="nav navbar-nav">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
                                ...
                                <li><a
                                        href="<%=basePath%>artCmtMng?userId=${user.id}"><i
                                        class="glyphicon glyphicon-cog"></i> 登录后台</a></li>
							</ul></li>
					</ul>
			...
			<div class="col-md-12">
			   <div class="col-md-12">
	            ...
	            action="addArt?userId=${user.id }&artId=${artId}" method="post" onsubmit="return isValidate(add_artical_form)">
	                ...
	                <div class="form-group">
	                    <textarea class="form-control"  name="summary"  placeholder="摘要" rows="5">
	                    ${selArticleInfo.summary }
	                    </textarea>
	                </div>
	                
	                <div class="form-group">
	                    <textarea class="form-control"  name="content"  placeholder="文章内容" rows="5">
