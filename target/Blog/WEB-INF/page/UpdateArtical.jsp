			   ...
			   <div class="col-md-12">					
	            ...
	            <form class="form-horizontal" name="add_artical_form" action="<%=basePath %>article?action=saveupdate&userId=${user.id }&artId=${art.id}" method="post">
	                <div class="col-md-6">
	                    ...
	                    <div class="form-group">
	                    <label >系统分类</label>
	                        <select class="form-control" name="sys_category" class="span3">
	                ...
	                <div class="form-group">
	                    <textarea class="form-control"  name="summary" class="span6" placeholder="摘要" rows="5">${art.summary }</textarea>
	                </div>
	                
	                <div class="form-group">
	                    <textarea class="form-control"  name="content" class="span6" placeholder="文章内容" rows="5">${art.content }</textarea>
	                </div>
