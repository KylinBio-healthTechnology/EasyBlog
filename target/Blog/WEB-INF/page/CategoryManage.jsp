	...
	<div class="container">
		...
		<div>
		 <!-- pager -->
          <ul class="pager">
          <c:if test="${curPage>1 }">         	
            <li class="previous"><a href="<%=basePath%>categoryManage&userId=${user.id }&curPage=${curPage-1}">&larr; 上一页</a></li>
           </c:if>
           <c:if test="${curPage<totalPages }">
            <li class="next"><a href="<%=basePath%>categoryManage&userId=${user.id }&curPage=${curPage+1}">下一页  &rarr;</a></li>
           </c:if>
          </ul>
		</div>
